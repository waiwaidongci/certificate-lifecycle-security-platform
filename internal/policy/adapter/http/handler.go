...
func (h *Handler) List(w http.ResponseWriter, r *http.Request) {
	options, err := query.ParseListOptions(r, map[string]bool{"name": true, "enabled": true}, map[string]bool{"name": true, "created_at": true, "updated_at": true}, "created_at")
	if err != nil {
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	item, err := h.service.Update(r.Context(), r.PathValue("id"), request.command())
	if err != nil {
		httpx.WriteError(r.Context(), w, err)
		return
	}
